...
class ProductPerOfficeRepository extends BaseRepositories
{
    ...
    {
        $data = array_merge($validator, $this->baseService->auditableInsert($request->userEmail));
    ...
    {
        $data = array_merge($validator, $this->baseService->auditableUpdate($request->userEmail));
